...
public class RestControlEmploye {
	...
	{
		Employe newEmploye = new Employe(employe.getNom(), employe.getPrenom(), employe.getEmail(), employe.isActif(), employe.getRole());
		iemployeservice.ajouterEmploye(newEmploye);
		return newEmploye;
	}
	...
	public int ajouterContrat(@RequestBody ContratDTO contrat) {
		return iemployeservice.ajouterContrat(new Contrat(contrat.getDateDebut(), contrat.getTypeContrat(), contrat.getSalaire()));
	}
